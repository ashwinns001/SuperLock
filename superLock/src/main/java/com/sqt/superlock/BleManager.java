...
import com.sqt.superlock.bluetooth.BleBluetooth;
import com.sqt.superlock.bluetooth.MultipleBluetoothController;
import com.sqt.superlock.bluetooth.SplitWriter;
import com.sqt.superlock.callback.BleGattCallback;
import com.sqt.superlock.callback.BleIndicateCallback;
import com.sqt.superlock.callback.BleMtuChangedCallback;
import com.sqt.superlock.callback.BleNotifyCallback;
import com.sqt.superlock.callback.BleReadCallback;
import com.sqt.superlock.callback.BleRssiCallback;
import com.sqt.superlock.callback.BleScanAndConnectCallback;
import com.sqt.superlock.callback.BleScanCallback;
import com.sqt.superlock.callback.BleWriteCallback;
import com.sqt.superlock.data.BleDevice;
import com.sqt.superlock.data.BleScanState;
import com.sqt.superlock.exception.OtherException;
import com.sqt.superlock.scan.BleScanRuleConfig;
import com.sqt.superlock.scan.BleScanner;
import com.sqt.superlock.utils.BleLog;
...
public class BleManager {
    ...
    public BluetoothGatt connect(BleDevice bleDevice, BleGattCallback bleGattCallback) {
        ...
        if (!isBlueEnable()) {
            ...
            BleLog.e("Bluetooth not enable!");
            bleGattCallback.onConnectFail(bleDevice, new OtherException("  "));
            return null;
        }
